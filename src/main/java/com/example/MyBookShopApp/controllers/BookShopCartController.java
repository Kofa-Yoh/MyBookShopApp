...
public class BookShopCartController {
    ...
    public String handleCartRequest(@CookieValue(value = "cartContents", required = false) String cartContents,
        ...
        if (cartContents == null || cartContents.equals("")) {
            ...
            model.addAttribute("cartCount", booksFromCookieSlugs.size());
            model.addAttribute("cartPriceOld", booksFromCookieSlugs.stream()
                    .mapToInt(book -> book.getPriceOld())
                    .sum());
            model.addAttribute("cartPrice", booksFromCookieSlugs.stream()
    ...
    public String handleRemoveBookFromStatus(@PathVariable("slug") String slug,
                                         @CookieValue(name = "cartContents", required = false) String cartContents,
                                         HttpServletResponse response,
                                         Model model) {
        if (cartContents != null && !cartContents.equals("")) {
